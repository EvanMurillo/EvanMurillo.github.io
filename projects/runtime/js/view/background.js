      ...
      var buildings = [];
        ...
        function render() {
            ...
            for (var i = 0; i < 5; ++i) {
                ...
                var building = draw.rect(75, buildingHeight, buildingColors[i], "Black", 1);// draws rectangle with 75 width, buldingHeight is the height, lightgrey is the fill color black is the outline and 1 is the outline width 
